...
const getRandomGames = () => {
  ...
  const randomGames2 = document.querySelector(".random-games2");
  const randomNums = [1,2,3,4];
  const randomNums2 = [5,6,7,8];
  ...
  randomNums2.forEach((num, i) => {
    ...
    randomGames2.insertAdjacentHTML("beforeend", html);
